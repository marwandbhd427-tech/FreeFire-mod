...
// Dobby declarations (بدون extern "C" لأن dobby.h يحتويها داخلياً)
#include "5Toubun/include/dobby.h"

// ═══════════════════════════════════════════════════════════════
// IL2CPP MANUAL DECLARATIONS
// ═══════════════════════════════════════════════════════════════
extern "C" {
...
void RunAimbotAndESP(ImDrawList* draw_list, ImVec2 screenSize) {
    ...
    if ((cfg.Aimbot || cfg.Aimbot100 || cfg.AutoAim) && secureTarget) {
        ...
        // ✅ FIX: static_cast<float> لمنع narrowing error
...
// ═══════════════════════════════════════════════════════════════
// ✅ FIX: ImGuiDrawView INTERFACE DECLARATION (مفقودة سابقاً)
// ═══════════════════════════════════════════════════════════════
